...
function UranusPlanet(scene) {
    ...
    material.map = THREE.ImageUtils.loadTexture('images/uranusmapthumb.jpg');
    ...
    material2.map = THREE.ImageUtils.loadTexture('images/uranusringcolour.jpg');
    material2.alphaMap = THREE.ImageUtils.loadTexture('images/uranusringtrans.jpg');
